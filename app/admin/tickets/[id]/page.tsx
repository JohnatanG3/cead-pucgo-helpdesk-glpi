		...
		try {
			...
			if (file) {
				try {
					...
					toast.error(
						"Não foi possível anexar o arquivo, mas a resposta foi enviada.",
					);
				}
			}
				...
				<div className="container mx-auto">
					<div className="mb-6">
						...
						<p className="text-sm text-muted-foreground mt-1">
							Aberto por Usuário #{ticket.users_id_recipient} em{" "}
