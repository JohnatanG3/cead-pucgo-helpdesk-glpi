...
import { getCategories, createCategory, updateCategory, deleteCategory, type GLPICategory } from "@/lib/glpi-api"
...
export default function AdminCategoriesPage() {
  ...
  const [editingCategory, setEditingCategory] = useState<GLPICategory | null>(null)
  ...
  const [categoryToDelete, setCategoryToDelete] = useState<GLPICategory | null>(null)
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground">Adicione, edite ou remova categorias de chamados</p>
            </div>
              ...
              <Dialog open={showNewCategoryDialog} onOpenChange={setShowNewCategoryDialog}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Preencha os campos abaixo para criar uma nova categoria de chamados.
                    </DialogDescription>
                  </DialogHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Estas são as categorias que os usuários podem selecionar ao criar um chamado.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {categories.length > 0 ? (
                  ...
                  {categories.map((category) => (
                    <div key={category.id} className="border rounded-lg p-4">
                      {editingCategory?.id === category.id ? (
                        ...
                        <div className="space-y-4">
                          <div className="space-y-2">
                            <Label htmlFor={`edit-name-${category.id}`}>Nome da Categoria</Label>
                            <Input
                          ...
                          <div className="flex justify-end gap-2">
                            ...
                            <Button size="sm" onClick={() => handleUpdateCategory(category.id)} disabled={isSubmitting}>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              <AlertDialog>
                                <AlertDialogTrigger asChild>
                                  <Button variant="ghost" size="sm" onClick={() => setCategoryToDelete(category)}>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      Tem certeza que deseja excluir a categoria "{category.name}"? Esta ação não pode
                                      ser desfeita.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                          ...
                          {category.comment && <p className="mt-2 text-sm text-muted-foreground">{category.comment}</p>}
                        </div>
                      )}
                    </div>
                  ))}
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="mt-2">Clique em "Nova Categoria" para adicionar a primeira categoria.</p>
                </div>
              )}
            </CardContent>
          </Card>
