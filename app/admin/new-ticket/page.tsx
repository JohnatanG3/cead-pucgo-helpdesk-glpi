  ...
  const handleSubmitTicket = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newTicket: Partial<GLPITicket> = {
        ...
        status: 1, // Novo
        type: 1, // Incidente
        users_id_recipient: requesterId ? Number.parseInt(requesterId) : user?.id ? Number.parseInt(user.id) : 1,
      }
            ...
            <form onSubmit={handleSubmitTicket}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={requesterId} onValueChange={setRequesterId} disabled={isSubmitting}>
                    <SelectTrigger>
                  ...
                  <p className="text-xs text-muted-foreground">Pessoa que está solicitando o chamado</p>
                </div>
