...
export default function TicketDetailContent({ ticketId }: { ticketId: string }) {
  ...
  const handleSubmitComment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (ticket && (selectedStatus !== ticket.status || selectedPriority !== ticket.priority)) {
        try {
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Avatar className="h-8 w-8">
                        ...
                        <AvatarFallback>
                          {followup.user?.email ? getEmailInitial(followup.user.email) : "U"}
                        </AvatarFallback>
                      </Avatar>
                      <div>
            ...
            <form onSubmit={handleSubmitComment}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Todos os tipos de arquivos são aceitos (máx. 5MB)</p>
                </div>
              </CardContent>
              <CardFooter>
