                ...
                <form onSubmit={handleUpdateProfile}>
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="email" value={user?.email} disabled placeholder="seu.email@pucgoias.edu.br" />
                      <p className="text-xs text-muted-foreground">O email não pode ser alterado</p>
                    </div>

                    <div className="p-4 bg-muted/50 rounded-md">
                      <p className="text-sm">
                        <strong>Nota:</strong> Para alteração de senha ou recuperação de acesso, utilize o portal
                        institucional da PUC-GO.
                      </p>
                    </div>
                  </CardContent>
