import { isRedisAvailable, getTokenFromRedis, saveTokenToRedis, removeTokenFromRedis } from "./redis-client"
 ...
 */
export async function setCachedValue<T>(key: string, value: T, expiresAt?: number): Promise<void> {
