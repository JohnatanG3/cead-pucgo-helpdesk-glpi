...
export function TicketHistory({
	...
	const mapGLPIHistoryTypeToLocal = (
		searchOption: number,
	): TicketHistoryEvent["type"] => {
					...
					<div className="relative space-y-4">
														...
														<div className="flex gap-2">
															...
															<Badge
																...
																className={cn(
																	...
																	event.details.to === "resolved" &&
																		"bg-green-100",
																	event.details.to === "in_progress" &&
																		"bg-blue-100",
																	event.details.to === "pending" &&
																		"bg-yellow-100",
																)}
															>
						...
						{!showFullHistory && events.length > 5 && (
							<div className="pt-2 text-center">
								<a
									href={`/dashboard/ticket/${ticketId}/history`}
